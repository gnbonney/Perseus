...
public class ProcedureGenerator implements GeneratorDelegate {
    ...
    public String createThunkClass(Map<String, Integer> varToField, PerseusParser.ExprContext actual, String baseType) {
        ...
        sb.append(".implements gnb/perseus/runtime/Thunk\n\n");
    ...
    public String generateProcedureReference(String procName, SymbolTableBuilder.ProcInfo procInfo) {
        ...
        if (outerProc != null && procedures != null && procedures.containsKey(outerProc)) {
            ...
            for (String p : outerInfo.paramNames) {
                ...
                if (!outerInfo.valueParams.contains(p)) {
                    desc = "Lgnb/perseus/compiler/Thunk;";
                } else {
        ...
        jasmin.append(".implements gnb/perseus/compiler/").append(interfaceName).append("\n\n");
        ...
        for (int i = 0; i < paramNames.size(); i++) {
            ...
            if (isValueParam) {
                ...
                jasmin.append("    dup\n");
                jasmin.append("    instanceof gnb/perseus/compiler/Thunk\n");
                jasmin.append("    ifeq ").append(notThunkLabel).append("\n");
                jasmin.append("    checkcast gnb/perseus/compiler/Thunk\n");
                jasmin.append("    invokeinterface gnb/perseus/compiler/Thunk/get()Ljava/lang/Object; 1\n");
