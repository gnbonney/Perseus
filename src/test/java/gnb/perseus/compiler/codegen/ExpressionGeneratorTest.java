...
public class ExpressionGeneratorTest {
    ...
    @BeforeEach
    public void setUp() {
        context = new ContextManager("test", "gnb/perseus/test", "TestClass", new HashMap<>(), new HashMap<>());
    ...
    public void testGenerateThunkLoad() {
        ...
        assertTrue(code.contains("invokeinterface gnb/perseus/runtime/Thunk/eval()Ljava/lang/Object; 1"), "Should call thunk eval");
    ...
    public void testGenerateProcedureReferenceAsValue() {
        ...
        assertTrue(code.contains("new gnb/perseus/test/TestClass$ProcRef0"), "Should instantiate a ProcRef class for the procedure");
